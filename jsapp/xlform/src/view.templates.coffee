...
invoice_extractor_config_templates =  require './view.invoiceExtractorConfig.templates'
...
module.exports = do ->
  ...
  templates['InvoiceExtractorConfigView.input']     = invoice_extractor_config_templates.invoiceExtractorConfigInput
